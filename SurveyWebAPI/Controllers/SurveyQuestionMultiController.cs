...
{
    [Authorize]
    [Route("api/Survey/Question/Multi")]
    [ApiController]
    public class SurveyQuestionMultiController : ControllerBase
    {
        private readonly DBHelper _db;
        public SurveyQuestionMultiController()
        {
        ...
        {
            Multi multi = JsonConvert.DeserializeObject<Multi>(value.ToString());
            string surveyId = multi.SurveyId;
            string questionId = multi.QuestionId;
            var replyData = new ReplyData();
            try
            {
                ...
                obj.Value = multi.QuestionSeq.ValidInt();;
                sqlParams.Add(obj);
                 obj = new SqlParameter("@QuestionType", SqlDbType.Int);
                obj.Value = multi.QuestionType.ValidInt();;
                sqlParams.Add(obj);
                 obj = new SqlParameter("@PageNo", SqlDbType.Int);
                obj.Value = multi.PageNo.ValidInt();;
                sqlParams.Add(obj);
                 obj = new SqlParameter("@IsRequired", SqlDbType.Bit);
                Log.Debug("multi.IsRequired:" + multi.IsRequired);
                obj.Value = multi.IsRequired.ValidBit();
                sqlParams.Add(obj);
                 obj = new SqlParameter("@HasOther", SqlDbType.Bit);
                Log.Debug("multi.HasOther:" + multi.HasOther);
                obj.Value = multi.HasOther.ValidBit();
                sqlParams.Add(obj);
                ...
                if (multi.main != null)
                {
                    ...
                    obj1.Value = multi.main.QuestionSubject.Valid();;
                    sqlParams.Add(obj1);
                    obj1 = new SqlParameter("@SubjectStyle", SqlDbType.NVarChar);
                    obj1.Value = multi.main.SubjectStyle.Valid();;
                    sqlParams.Add(obj1);
                    obj1 = new SqlParameter("@QuestionNote", SqlDbType.NVarChar);
                    obj1.Value = multi.main.QuestionNote.Valid();;
                    sqlParams.Add(obj1);
                    obj1 = new SqlParameter("@QuestionImage", SqlDbType.NVarChar);
                    obj1.Value = multi.main.QuestionImage.Valid();;
                    sqlParams.Add(obj1);
                    obj1 = new SqlParameter("@QuestionVideo", SqlDbType.NVarChar);
                    obj1.Value = multi.main.QuestionVideo.Valid();;
                    sqlParams.Add(obj1);
                    //-------sql para----end
                }
                if (multi.main.other != null)
                {
                    ...
                    Log.Debug("OtherIsShowText:" + multi.main.other.OtherIsShowText);
                    obj2.Value = multi.main.other.OtherIsShowText.ValidBit();
                    sqlParams.Add(obj2);
                    obj2 = new SqlParameter("@OtherVerify", SqlDbType.Int);
                    obj2.Value = (multi.main.other.OtherVerify).ValidInt();;
                    sqlParams.Add(obj2);
                    obj2 = new SqlParameter("@OtherMandatory", SqlDbType.Bit);
                    Log.Debug("OtherMandatory:" + multi.main.other.OtherMandatory);
                    obj2.Value = multi.main.other.OtherMandatory.ValidBit();
                    sqlParams.Add(obj2);
                    obj2 = new SqlParameter("@OtherCheckMessage", SqlDbType.NVarChar);
                    obj2.Value = multi.main.other.OtherCheckMessage.Valid();;
                    sqlParams.Add(obj2);
                    obj2 = new SqlParameter("@OtherMinLimit", SqlDbType.Int);
                    obj2.Value = multi.main.other.OtherMinLimit.ValidInt();;
                    sqlParams.Add(obj2);
                    obj2 = new SqlParameter("@OtherMaxLimit", SqlDbType.Int);
                    obj2.Value = multi.main.other.OtherMaxLimit.ValidInt();;
                    sqlParams.Add(obj2);
                    //-------sql para----end

                    if (!String.IsNullOrEmpty(multi.main.other.OtherChildQuestionId))
                    {
                        ...
                        obj3.Value = multi.main.other.OtherChildQuestionId.ValidGuid();
                        sqlParams.Add(obj3);
                        //-------sql para----end
                    }
                }
                if (multi.advance != null)
                {
                    sqlSB.Append(",MultiOptionLimit=@MultiOptionLimit ");
                    //-------sql para----start
                    var obj4 = new SqlParameter("@MultiOptionLimit", SqlDbType.NVarChar);
                    obj4.Value = multi.advance.MultiOptionLimit.Valid();;
                    sqlParams.Add(obj4);
                    //-------sql para----end

                    if (multi.advance.showWay != null)
                    {
                        sqlSB.Append(",IsSetShowNum=@IsSetShowNum,PCRowNum=@PCRowNum,MobileRowNum=@MobileRowNum ");
                        //-------sql para----start
                        var obj5 = new SqlParameter("@IsSetShowNum", SqlDbType.Bit);
                        Log.Debug("IsSetShowNum:" + multi.advance.showWay.IsSetShowNum);
                        obj5.Value = multi.advance.showWay.IsSetShowNum.ValidBit();
                        sqlParams.Add(obj5);
                        obj5 = new SqlParameter("@PCRowNum", SqlDbType.Int);
                        obj5.Value = multi.advance.showWay.PCRowNum.ValidInt();
                        sqlParams.Add(obj5);
                        obj5 = new SqlParameter("@MobileRowNum", SqlDbType.Int);
                        obj5.Value = multi.advance.showWay.MobileRowNum.ValidInt();
                        sqlParams.Add(obj5);
                        //-------sql para----end
                    }
                    if (multi.advance.random != null)
                    {
                        sqlSB.Append(",IsRamdomOption=@IsRamdomOption,ExcludeOther=@ExcludeOther ");
                        //-------sql para----start
                        var obj6 = new SqlParameter("@IsRamdomOption", SqlDbType.Bit);
                        Log.Debug("IsRamdomOption:" + multi.advance.random.IsRamdomOption);
                        obj6.Value = multi.advance.random.IsRamdomOption.ValidBit();
                        sqlParams.Add(obj6);
                        obj6 = new SqlParameter("@ExcludeOther", SqlDbType.Bit);
                        Log.Debug("IsRamdomOption:" + multi.advance.random.ExcludeOther);
                        obj6.Value = multi.advance.random.ExcludeOther.ValidBit();
                        sqlParams.Add(obj6);
                        //-------sql para----end
                    }
                }
                ...
                //-------sql para----start
                var obj7 = new SqlParameter("@SurveyId", SqlDbType.UniqueIdentifier);
                obj7.Value = multi.SurveyId.ValidGuid();
                sqlParams.Add(obj7);
                obj7 = new SqlParameter("@QuestionId", SqlDbType.UniqueIdentifier);
                obj7.Value = multi.QuestionId.ValidGuid();
                sqlParams.Add(obj7);
                //-------sql para----end
                ...
                sqlParamsA[0].Value = multi.QuestionId.ValidGuid();
                //-------sql para----end
                Log.Debug("delete QUE003_QuestionnaireOptions:" + sqlS);
                int dR = _db.ExecuteSql(sqlS, sqlParamsA);

                if (multi.main.option != null)
                {
                    foreach (Option opt in multi.main.option)
                    {
                        ...
                        if (opt.ChildQuestionId == null || string.IsNullOrEmpty(opt.ChildQuestionId))
                        {
                            ...
                            sqlParamsB[0].Value = multi.QuestionId.ValidGuid();
                ...
                if (Convert.ToBoolean(multi.HasOther))
                {
                    optionCount++;
                    if (multi.main.other.OtherChildQuestionId == null || string.IsNullOrEmpty(multi.main.other.OtherChildQuestionId))
                    {
                        sqlS = @"
...
values(@QuestionId,@Guid,@optionCount, 0,'其它',null,@userId,SYSDATETIME(),'','','1') ";
                        ...
                        sqlParamsC[0].Value = multi.QuestionId.ValidGuid();
...
values(@QuestionId,@Guid,@optionCount, 0,'其它',@OtherChildQuestionId,@userId,SYSDATETIME(),'','','1') ";
                        ...
                        sqlParamsC[2].Value = optionCount.ValidInt();
                        sqlParamsC[3].Value = userId.ValidGuid();
                        sqlParamsC[4].Value = multi.main.other.OtherChildQuestionId.ValidGuid();
                        //-------sql para----end
                        iR += _db.ExecuteSql(sqlS, sqlParamsC);
                    }
            ...
            catch (Exception ex)
            {
                ...
                replyData.data = null;
                Log.Error("api/Survey/Question/Multi/Update 更新資料失敗!" + ex.Message);
            }
            return JsonConvert.SerializeObject(replyData);
        }
        [Route("Delete")]
        ...
        protected Multi QueryData(int opType, string surveyId, string questionId, bool otherFlag)
        {
            //data實體
            ...
            try
            {
                ...
                {
                    //Fill data
                    multi.SurveyId = dtR.Rows[0]["SurveyId"].ToString().Trim();
                    multi.QuestionId = dtR.Rows[0]["QuestionId"].ToString().Trim();
                    if (dtR.Rows[0]["QuestionSeq"] == null || string.IsNullOrEmpty(dtR.Rows[0]["QuestionSeq"].ToString().Trim()))
                        multi.QuestionSeq = 1;
                    else
                        multi.QuestionSeq = int.Parse(dtR.Rows[0]["QuestionSeq"].ToString().Trim());
                    if (dtR.Rows[0]["QuestionType"] == null || string.IsNullOrEmpty(dtR.Rows[0]["QuestionType"].ToString().Trim()))
                        multi.QuestionType = 1;
                    else
                        multi.QuestionType = int.Parse(dtR.Rows[0]["QuestionType"].ToString().Trim());
                    multi.IsRequired = dtR.Rows[0]["IsRequired"].ToString().Trim();
                    multi.HasOther = dtR.Rows[0]["HasOther"].ToString().Trim();
                    if (dtR.Rows[0]["PageNo"] == null || string.IsNullOrEmpty(dtR.Rows[0]["PageNo"].ToString().Trim()))
                        multi.PageNo = 1;
                    else
                        multi.PageNo = int.Parse(dtR.Rows[0]["PageNo"].ToString().Trim());
                    ...
                    {
                        main.other = null;
                        AdvanceM advance = new AdvanceM();
                        advance.MultiOptionLimit = null;
                        advance.showWay = null;
                        advance.random = null;
                        multi.advance = advance;
                    }
                    else
                    {
                        ...
                        AdvanceM advance = new AdvanceM();
                        advance.MultiOptionLimit = dtR.Rows[0]["MultiOptionLimit"].ToString().Trim();
